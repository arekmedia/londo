...
<table style="border:1px dashed #45D4FF" >
	<tr>
		...
		<td style="padding-left:10px;"> <?php echo $r_exper_list->exper_position; ?> - <?php echo $r_exper_list->spes_value; ?><div style="float:right"><a href="#" onclick="loadfileid('edit_exper','<?php echo $r_exper_list->exper_id; ?>')"><img src="<?php echo base_url()."media/images/edit_24.png"; ?>"></a> &nbsp; <a href="#" onclick="delete_exper('<?php echo $r_exper_list->exper_id; ?>')"><img src="<?php echo base_url()."media/images/trash_24.png"; ?>"></a> </div></td>
	</tr>
	<tr>
